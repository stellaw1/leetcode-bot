<template>
    <!-- <footer class="footer footer-right p-2 text-base-content border-solid border border-gray-200">
        <div>
    ...
    <footer class="footer items-center p-4 border-solid border border-gray-200">
